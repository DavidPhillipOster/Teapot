...
function indexToPoints2(a,n) = [for (i=[0:3]) ducks[a[i+n]] ];
function indexToPoints(a) = [for (i=[0:3]) indexToPoints2(a, i*4)];


// patches[0] is a 4x4 list of indices; OpenSCAD wants a list of points
// scale([30,30,30])for (i=[0:15]) {  translate(ducks[patches[0][i]])sphere(d=0.1); }
